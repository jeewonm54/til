...
머신러닝의 주된 목적은 예측 + 예측력이 얼마나 높은가에 집중 -> 그렇기 때문에 분석 모형의 복잡성이 높으며, 고질적인 문제인 과적합(학습 데이터를 과하게학습하여 예측 데이터에 대한 정확도가 감소하는 현상) 해결에 집중함

통계학의 주된 목적은 해석 -> 모델의 신뢰도를 중시. 복잡성<단순성 
